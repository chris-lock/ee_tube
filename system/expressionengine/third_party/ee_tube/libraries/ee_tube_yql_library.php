...
class Ee_tube_yql_library {
	...
	*/
	public function run_query($sql, $params = array()) {
		...
		$query_url = Ee_tube_yql_library::YQL_SERVICE_URL.'?'.$param_string;

		// Fire off the request
		$this->EE->load->library('ee_tube_curl_library');
		$curl_result = $this->EE->ee_tube_curl_library->do_curl($query_url);
...
/* End of file ee_tube_yql_library.php */
/* Location: /system/expressionengine/third_party/ee_tube/libraries/ee_tube_yql_library.php */